...
const Navbar = () => {
  ...
  shadow-lg shadow-black/5"
    ...
    ${active === link.id ? "text-white" : "text-gray-800 hover:text-red-500"}
  `}
            >
              ...
              <div className="flex flex-col h-full justify-center items-end px-6 space-y-6">
                {links.map((link) => (
                  <motion.button
                    ...
                    className="text-2xl font-semibold text-gray-900 hover:text-blue-500 transition-colors text-right"
                  >
                    {link.label}
                  </motion.button>
                ))}
